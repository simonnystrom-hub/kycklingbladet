...
export const PRIVACY_SECTIONS: {heading: string; paragraphs: string[]}[] = [
  {
    ...
    paragraphs: [
      'Personuppgiftsansvarig för behandlingen är den som driver Kycklingbladet på www.kycklingbladet.com. Frågor om personuppgifter, denna policy och utövande av dina rättigheter skickas via kontaktsidan. Vi uppger där inte e-post i klartext, för att minska skräppost, men meddelanden läses av den som ansvarar för sajten.',
    ],
  },
  {
    heading: 'Vilka personuppgifter vi behandlar',
    paragraphs: [
  ...
  {
    heading: 'Överföring till land utanför EU/EES',
    paragraphs: [
      'Vercel är ett amerikanskt bolag. Sanity kan behandla data i och utanför EU beroende på konfiguration. När personuppgifter överförs till USA eller annat land utan beslut om adekvat skyddsnivå sker det med de skyddsåtgärder som GDPR kräver, i första hand EU-kommissionens standardavtalsklausuler tillsammans med leverantörernas tilläggsåtgärder.',
    ],
  },
  {
  ...
  },
  {
    heading: 'Klagomål',
    paragraphs: [
      'Du har rätt att klaga till Integritetsskyddsmyndigheten (IMY) om du anser att vi behandlar dina personuppgifter i strid med GDPR. Information finns på imy.se.',
    ],
  },
  {
    heading: 'Barn',
    paragraphs: [
      'Sajten vänder sig inte till barn. Kontaktsidan ska inte användas av den som är under 13 år. Om vi får kännedom om att vi har samlat in uppgifter om ett barn raderar vi dem.',
    ],
  },
  {
    heading: 'Ändringar',
    paragraphs: [
      'Vi kan uppdatera denna policy om behandlingen ändras. Den version som publiceras på denna sida gäller. Datum för senaste uppdatering anges ovan.',
    ],
  },
]
